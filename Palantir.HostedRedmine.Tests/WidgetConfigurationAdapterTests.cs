namespace Palantir.HostedRedmine.Tests
{
    ...
    public class WidgetConfigurationAdapterTests : IDisposable
    {
        ...
        public void ReturnsServiceName()
        {
            ...
            // Then
            Assert.Equal("Palantir.HostedRedmine.RestApiService, Palantir.HostedRedmine", serviceName);
        }
        ...
        public void ReturnsAdaptedUrl()
        {
            ...
            // Then
            Assert.Equal("http://www.hostedredmine.com/projects/test-credit-system/issues.json?status_id=8&limit=100", adaptedUrl.ToString());
        }
